                    ...
                    <div class="todo-app-list">
                        ...
                        <div class="todo-task-list-wrapper list-group ps ps--active-y">
                            <ul class="todo-task-list media-list" id="todo-task-list">
                                ...
                                </li><li class="todo-item completed">
                                    <div class="todo-title-wrapper">
                                        <div class="todo-title-area">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical drag-icon"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg>
                                            <div class="title-wrapper">
                        ...
                        <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 429px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 135px;"></div></div></div>
                        <!-- Todo List ends -->
                    </div>
                                    ...
                                    <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                                        <div class="action-tags">
                                            ...
                                            <div class="form-group position-relative">
                                                ...
                                                <div class="position-relative"><select class="select2 form-control select2-hidden-accessible" id="task-assigned" name="task-assigned" data-select2-id="task-assigned" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="form-group my-1">
                                            <button type="submit" class="btn btn-primary add-todo-item mr-1 waves-effect waves-float waves-light">Add</button>
                                            <button type="button" class="btn btn-outline-secondary add-todo-item waves-effect" data-dismiss="modal">
                                                Cancel
                                            </button>
                                            <button type="button" class="btn btn-primary d-none update-btn update-todo-item mr-1 waves-effect waves-float waves-light">Update</button>
                                            <button type="button" class="btn btn-outline-danger update-btn d-none waves-effect" data-dismiss="modal">Delete</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
