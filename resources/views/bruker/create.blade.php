                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                            ...
                            <input type="text" name="title" class="form-control credit-card-mask @error('title') border border-danger @enderror" placeholder="Genser, bukser, sokker" id="credit-card">
                            @error('title')
