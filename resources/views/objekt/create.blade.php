<div class="col-lg-4 col-md-6 col-12">
    <div class="card card-developer-meetup">
        ...
        <div class="card-body">
            <div class="meetup-header d-flex align-items-center">
                ...
                <div class="my-auto">
                    ...
                    <p class="card-text mb-0">Opprett nye objekter</p>
                </div>
            </div>
            @if (session('status'))
        ...
        @endif
            <form method="post" action="{{asset('objekt')}}">
                @csrf
            <div class="media">
                ...
                <div class="media-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('objekt') border border-danger @enderror" name="objekt" id="basicInput">
                            @error('objekt')
            ...
            <div class="media mt-2">
                ...
                <div class="media-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('max') border border-danger @enderror" id="basicInput" name="max">
                        @error('max')
                        <div class="text-danger">
